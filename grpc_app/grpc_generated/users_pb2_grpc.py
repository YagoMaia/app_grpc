...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in protos/users_pb2_grpc.py depends on'
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NewUser = channel.unary_unary(
                '/UserService/NewUser',
                request_serializer=NewUserRequest.SerializeToString,
                response_deserializer=NewUserResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NewUser': grpc.unary_unary_rpc_method_handler(
                    servicer.NewUser,
                    request_deserializer=NewUserRequest.FromString,
                    response_serializer=NewUserResponse.SerializeToString,
            ),
...
class UserService(object):
    ...
    def NewUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UserService/NewUser',
            NewUserRequest.SerializeToString,
            NewUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DeleteUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UserService/DeleteUser',
            DeleteRequest.SerializeToString,
            DeleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UserService/UpdateUser',
            UpdateRequest.SerializeToString,
